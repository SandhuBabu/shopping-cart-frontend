...
const Footer = () => {
  return (
    <footer className='bg-base-300 pb-5'>
      ...
      <div className="footer px-10 py-4 border-t border-base-100">
        <aside className="items-center grid-flow-col">
          ...
          <p>Shopping Cart Pvt Ltd. <br />Providing reliable fashion products since 1992</p>
        </aside>
