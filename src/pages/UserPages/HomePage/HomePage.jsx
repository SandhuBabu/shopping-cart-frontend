    ...
    <>
      ...
      <section className='w-full mt-[3em]'>
        ...
        <Link to='/products?gender=female'>
          <div className="carousel-item relative w-full h-[18em] rounded-xl overflow-hidden">
            <img src={WomesSale} className="w-full md:h-[auto] h-[13em]" />
          </div>
        </Link>
      </section>
      ...
      <section className='w-full px-3 mt-[3em]'>
        ...
        <Link to="/products?gender=male">
          <div className="carousel-item relative w-full h-[18em] rounded-xl overflow-hidden">
            <img
              src="https://assets.myntassets.com/f_webp,w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2023/10/25/913049a9-7bfe-450f-a09e-84eccf2482f21698217415424-Dussehra_Banner-MEN-Without-Date.jpg"
              className="w-full md:h-[auto] h-[13em]"
            />
          </div>
        </Link>
      </section>
